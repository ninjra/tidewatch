...
property-based tests targeting implementation correctness and
...
scalarization.  EDF is theoretically optimal for deadline
...
No field deployment, user study, or real physiological dataset is
presented; external validity remains an open question.  The primary
