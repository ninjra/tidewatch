...
with 540 deterministic and property-based tests---including 23
...
missed deadlines.  The implementation comprises 1{,}599 lines of
...
standard library.
The core library comprises 1{,}599 lines across seven modules:
...
\midrule
\texttt{pressure.py}   & 499 \\
\texttt{types.py}      & 279 \\
\texttt{components.py} & 240 \\
\texttt{planner.py}    & 219 \\
\texttt{constants.py}  & 202 \\
\texttt{triage.py}     & 114 \\
\texttt{\_\_init\_\_.py} & 46 \\
\midrule
\textbf{Total}         & \textbf{1{,}599} \\
\bottomrule
\end{tabular}
\end{table}
...
The full test suite comprises 540 tests organized into 21
...
At 1{,}599 lines with zero dependencies and 537 deterministic tests,
